...
import { ShapesUploadGrid } from "@/app/dashboard/shapes/_components/shapes-upload-grid";
...
type ShapesManagerProps = {
  cards: ShapeCard[];
};

export function ShapesManager({ cards }: ShapesManagerProps) {
      ...
      <div className="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end">
        <div>
          ...
          <p className="mt-4 max-w-2xl text-lg leading-relaxed text-on-surface-variant">
            Upload and manage shape visuals and pronunciation audio for shape
            learning activities.
          </p>
        </div>
