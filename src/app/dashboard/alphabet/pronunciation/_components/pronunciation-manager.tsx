...
type PronunciationManagerProps = {
  cards: PronunciationCard[];
};

export function PronunciationManager({ cards }: PronunciationManagerProps) {
      ...
      <div className="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end">
        <div>
          ...
          <p className="mt-4 max-w-2xl text-lg leading-relaxed text-on-surface-variant">
            Upload and manage spoken alphabet references for each letter. Keep
            every recording clear, consistent, and easy for children to follow.
          </p>
        </div>
