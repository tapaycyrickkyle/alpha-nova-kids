...
import { ColorsUploadGrid } from "@/app/dashboard/colors/_components/colors-upload-grid";
...
export function ColorsManager({ cards }: ColorsManagerProps) {
      ...
      <div className="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end">
        <div>
          ...
          <p className="mt-4 max-w-2xl text-lg leading-relaxed text-on-surface-variant">
            Upload and manage visual references for your color curriculum. Keep
            every swatch bold, readable, and child-friendly for a clear learning
            experience.
          </p>
        </div>
