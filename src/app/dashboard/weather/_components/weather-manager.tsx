...
import { WeatherUploadGrid } from "@/app/dashboard/weather/_components/weather-upload-grid";
...
export function WeatherManager({ cards }: WeatherManagerProps) {
      ...
      <div className="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end">
        <div>
          ...
          <p className="mt-4 max-w-2xl text-lg leading-relaxed text-on-surface-variant">
            Upload and manage visuals and pronunciation audio for everyday weather
            lessons.
          </p>
        </div>
