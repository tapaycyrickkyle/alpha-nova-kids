...
import { HomeMenuUploadGrid } from "@/app/dashboard/menu-buttons/_components/home-menu-upload-grid";
...
type MenuButtonsManagerProps = {
  cards: HomeMenuCard[];
};

export function MenuButtonsManager({ cards }: MenuButtonsManagerProps) {
      ...
      <div className="mb-12 flex flex-col justify-between gap-6 md:flex-row md:items-end">
        <div>
          ...
          <p className="mt-4 max-w-2xl text-lg leading-relaxed text-on-surface-variant">
            Upload and manage the home menu category visuals and audio labels.
          </p>
        </div>
