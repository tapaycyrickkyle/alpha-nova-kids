            ...
            <div className="mb-4">
              <div className="min-w-0">
                ...
                <p className="text-xs text-on-surface-variant">
                  Add a visual reference for this home menu category.
                </p>
              </div>
            </div>
              ...
              {imageState.previewUrl ? (
                ...
                <>
                  ...
                  <p className="mt-1 max-w-[14rem] text-sm text-on-surface-variant">
                    Use a clear child-friendly image for the category.
                  </p>
                </>
              )}
            </div>
          ...
          <section className="rounded-2xl border border-surface-variant/20 bg-white/70 p-4">
            <div className="mb-4">
              <div className="min-w-0">
                ...
                <p className="text-xs text-on-surface-variant">
                  Upload the MP3 category pronunciation clip.
                </p>
              </div>
            </div>
...
export function HomeMenuUploadGrid({
  cards,
  onPendingImagesChange,
  uploadAllToken = 0,
  onUploadAllComplete,
}: HomeMenuUploadGridProps) {
